...
function SkillCard({ name, img }: SkillProps) {
  return (
    <div className="py-1 px-3 bg-[#F4F4F4] rounded-lg border border-[#E0E0E0] flex items-center gap-1">
      <Image src={img} alt={name} width={16} height={16} className="object-contain size-6" />
      <div className="text-black text-sm font-medium leading-3">{name}</div>
    </div>
  );
}
...
const languages: SkillProps[] = [
  ...
  { name: "TypeScript", img: "https://img.icons8.com/fluency/48/typescript--v2.png" },
  { name: "React", img: "https://img.icons8.com/office/40/react.png" },
    { name: "Next.js", img: "https://img.icons8.com/fluency/48/nextjs.png" },
    { name: "Tailwind CSS", img: "https://img.icons8.com/fluency/48/tailwind_css.png" },
...
const tools: SkillProps[] = [
  ...
  { name: "GitHub", img: "https://img.icons8.com/?size=100&id=LoL4bFzqmAa0&format=png&color=000000" },
  { name: "VS Code", img: "https://img.icons8.com/?size=100&id=9OGIyU8hrxW5&format=png&color=000000" },
  { name: "Figma", img: "https://img.icons8.com/?size=100&id=zfHRZ6i1Wg0U&format=png&color=000000" },
];

const databases: SkillProps[] = [
  { name: "MongoDB", img: "https://img.icons8.com/?size=100&id=tBBf3P8HL0vR&format=png&color=000000" },
  { name: "PostgreSQL", img: "https://img.icons8.com/?size=100&id=38561&format=png&color=000000" },
];
